...
p1 <- plots_power2000[[1]]$data
p2 <- plots_power2000[[4]]$data
p3 <- plots_power2000[[7]]$data
p4 <- plots_power2000[[10]]$data
...
p1 <- plots_power5000[[1]]$data
p2 <- plots_power5000[[4]]$data
p3 <- plots_power5000[[7]]$data
p4 <- plots_power5000[[10]]$data
...
p1 <- plots_power10000[[1]]$data
p2 <- plots_power10000[[4]]$data
p3 <- plots_power10000[[7]]$data
p4 <- plots_power10000[[10]]$data
...
p1 <- plots_distr500[[3]][[1]] + 
  labs(title =NULL, x=NULL, caption = "500 observations") + theme(plot.caption = element_text(size = 9, hjust = 0.5, vjust = 0.5, face = "bold"))
p2 <- plots_distr2K[[3]][[1]] + 
  labs(title= NULL, x=NULL, caption = "2K observations") + theme(plot.caption = element_text(size = 9, hjust = 0.5, vjust = 0.5, face = "bold"))
p3 <- plots_distr5K[[3]][[1]] + 
  labs(title= NULL, x=NULL, caption = "5K observations") + theme(plot.caption = element_text(size = 9, hjust = 0.5, vjust = 0.5, face = "bold"))
p4 <- plots_distr10K[[3]][[1]] + 
  labs(title= NULL, x=NULL, caption = "10K observations") + theme(plot.caption = element_text(size = 9, hjust = 0.5, vjust = 0.5, face = "bold"))

plots_distr_all_trans1 <- ( p1+p2) / (p3+p4) +
                 plot_layout(guides = "collect") + 
  plot_annotation(title = "Coefficients distribution for transition Dementia-fre to Dementia",
    theme = theme(plot.title = element_text(size = 13, face = "bold", hjust = 0.5)))
