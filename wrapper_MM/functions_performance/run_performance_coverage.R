run_performance_coverage <- function(n_pats, scheme, seed) {
  ...
  ci_lower_msm <- model.msm$ci[4:12, 1]
  ci_upper_msm <- model.msm$ci[4:12, 2]
  
  ci_lower_msm <- matrix(ci_lower_msm, nrow = 3, ncol = 3)
  ci_upper_msm <- matrix(ci_upper_msm, nrow = 3, ncol = 3)
  ...
  ci_lower_msm_age <- matrix(ci_lower_msm_age, nrow = 3, ncol = 3)
  ci_upper_msm_age <- matrix(ci_upper_msm_age, nrow = 3, ncol = 3)
