run_performance_bias_rel <- function(n_pats, scheme, seed, convergence){
  ...
  bias_EO <- compute_bias_rel(params_EO, ground_truth_params)
  ...
  if (convergence$flexsurv[seed]==2){
    ...
    bias_flexsurv <- compute_bias_rel(params_flexsurv, ground_truth_params)
  ...
  if (convergence$msm[seed]==2){
    ...
    bias_msm <- compute_bias_rel(params_msm, ground_truth_params)
    bias_msm[,1:2] <-NA
  } else {
  ...
  if (convergence$msm_age[seed]==2){
    ...
    bias_msm_age <- compute_bias_rel(params_msm_age, ground_truth_params)
  ...
  if (convergence$nhm[seed]==2){
    ...
    bias_nhm <- compute_bias_rel(params_nhm, ground_truth_params)
  } else{
  ...
  if (convergence$imputation[seed]==2){
    ...
    bias_imputation <- compute_bias_rel(params_imp, ground_truth_params)
  } else{
